...
public class TestInsercion {
	...
	private static Persona getPersona() {
		...
		NombreCompleto nombreCompleto = new NombreCompleto("Jorge", "Arturo", "Madrigal", "Chávez");
		Persona persona = new Persona(102,"Jorge Arturo Madrigal Chávez", "Ing en Sistemas",
